        ...
        <div class="card mb-3">
            @if ($posts[0]->image)
                <div style="max-height: 400px; overflow: hidden;">
                    <img src="{{ asset('storage/' . $posts[0]->image) }}" class="img-fluid" height="400"
                        alt="{{ $posts[0]->category->name }}">
                </div>
            @else
                <div style="max-height: 400px; overflow: hidden;">
                    <img src="/img/{{ $posts[0]->category->name === 'Personal' ? 'hero.jpg' : 'programming.jpg' }}"
                        class="img-fluid" height="400" alt="{{ $posts[0]->category->name }}">
                </div>
            @endif
